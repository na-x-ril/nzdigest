...
Expected JSON Schema:
{
  ...
  "kronologiAlur": [
    "First key point chronologically from the transcript.",
    "Second key point chronologically from the transcript.",
    "And so on..."
  ],
  "poinPoinKunci": [
    {
      "judul": "Title of Key Point 1 (from transcript)",
      "penjelasan": "Detailed explanation for key point 1, based on the transcript."
    }
  ],
  "pembelajaranInsight": [
    {
      "judul": "Title of Important Learning/Insight 1 (from transcript)",
      "penjelasan": "Explanation for important learning or insight 1, based on the transcript."
    }
  ],
    ...
    try {
      ...
      const chatCompletion = await groq.chat.completions.create({
        messages: [
          ...
          {
            role: 'user',
            content: `Please summarize the following transcript according to the instructions and JSON format provided:\n\n${input.transcript}`,
          },
        ],
